      ...
      (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
          ...
          reader.onload = (e) => {
            ...
            setFormData((prev: any) => ({ ...prev, profilePic: result }));
          };
...
const ProfileStats = React.memo(({ profile }: { profile: any }) => {
...
const ProfilePicture = React.memo(({ profile }: { profile: any }) => {
...
const ProfileInfo = React.memo(({ profile }: { profile: any }) => {
...
const Content: React.FC = () => {
  const { auth, updateUserProfile } = useStore();
  const {
    subscriptions,
    loading,
...
//   const { profile, loading, error, mutate } = useProfile();
  ...
  useEffect(() => {console.log('sss', subscriptions)}, [subscriptions])
