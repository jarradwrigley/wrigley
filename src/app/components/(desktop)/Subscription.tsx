...
//       subscription.subscriptionType?.[0] || "subscription";
...
//               </h3>
//               <p className="text-sm text-gray-600">
//                 {capitalizeFirstLetter(primaryCategory)} •{" "}
//                 {subscription.phoneNumber}
//               </p>
//               {subscription.subscriptionType.length > 1 && (
//                 <p className="text-xs text-gray-500">
//                   +{subscription.subscriptionType.length - 1} more categories
//                 </p>
//               )}
//             </div>
//           </div>
