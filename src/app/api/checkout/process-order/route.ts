...
async function sendOrderConfirmationEmail(order: any) {
  ...
  const emailData = {
    ...
    to: [
      {
        ...
        name: `${escapeHTML(order.paymentDetails.firstName)} ${
          escapeHTML(order.paymentDetails.lastName)
        }`,
      },
    ],
    ...
    textContent: `
        ...
        Billing Address: ${escapeHTML(order.billingAddress.fullAddress)}
        Delivery Address: ${escapeHTML(order.deliveryAddress.fullAddress)}
